// pages/CnGamePage/CnGamePage.js
...
      }).end().then(  res => {  
        ...
        // console.log(this.data.fakeAnswers[this.data.ques_id].w_cn_interpre.length);
        if(this.data.fakeAnswers[this.data.ques_id].w_cn_interpre.length<13){
          this.setData({
            iscenter:true ,
            isOneEnd:false,
            isCorrect:true
